...
public class TriviaGame {
    ...
    private void populateTriviaList() {
        ...
        trivias.add(new Trivia("What mob shoots a bow and arrow?", "Skeleton"));
        trivias.add(new Trivia("How many diamonds do you need for a diamond sword?", "2"));
        trivias.add(new Trivia("How many dimensions are there?", "3"));
        trivias.add(new Trivia("What shiny metal do piglins love?", "Gold"));
        trivias.add(new Trivia("Where are endermen from?", "End"));
